...
$(document).ready(function () {
  ...
  // remove sidebar
  $(".sidebar-close-icon").on("click", function () { /*.shop-content-overlay, */
  ...
  if (checkoutWizard.length > 0) {
	...
	$( ".quantity-counter" ).each(function() {
		  ...
		  var quantityCounter = $(this),
			CounterMin = parseInt(quantityCounter.data('min')),
			CounterMax = parseInt(quantityCounter.data('max'));
