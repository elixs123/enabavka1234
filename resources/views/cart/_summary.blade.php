...
<div class="detail">
    ...
    <div class="detail-amt discount-amt">@php $disc = ($document->has_discount) ? ($price - ($document->useMpcPrice() ? $document->total_discounted : $document->subtotal_discounted)) : 0; @endphp
