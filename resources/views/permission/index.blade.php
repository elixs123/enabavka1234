...
@section('head_title', $title = trans('permission.title'))
            ...
            <div class="form-group breadcrum-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right p-0">
                        ...
                        <a class="dropdown-item" href="{{ route('permission.create') }}" data-toggle="modal" data-target="#form-modal1">{{ trans('permission.actions.create') }}</a>
                        @endcan
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4 col-lg-3">
                                        {!! VuexyAdmin::selectTwo('object', $objects, request('object'), ['data-plugin-options' => '', 'id' => 'filters-object'], trans('permission.data.object')) !!}
                                    </div>
                                    <div class="col-12 col-sm-4 col-lg-3">
                            ...
                            <div class="table-responsive-lg">
                                <table class="table table-hover mb-0">
                                    <thead class="thead-light">
                                        <tr>
                                            <th>{{ trans('permission.data.name') }}</th>
                                            <th>{{ trans('permission.data.object') }}</th>
                                    ...
                                    <tbody data-ajax-form-body="permissions">
                                        @foreach($items as $id => $item)
                                        @include('permission._row')
                                        @endforeach
                                    </tbody>
                                </table>
                            </div>
